...
function FeedbackList() {
  ...
  return (
    <ContentWrapper>
      {categoryToFilter
        ? filteredFeedbackList.map((feedback: IFeedback) => <FeedbackCardWrapper key={uuidv4()} feedback={feedback} />)
        : feedbackList.map((feedback: IFeedback) => <FeedbackCardWrapper key={uuidv4()} feedback={feedback} />)}
    </ContentWrapper>
  );
}
